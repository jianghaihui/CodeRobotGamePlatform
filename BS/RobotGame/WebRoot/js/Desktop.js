...
Ext.Desktop = function () {
    ...
    if (shortcutsEl) {
        ...
        for (var i = 0; i < shortcutJson.getCount(); i++) {
            ...
            shortcutsEl.insertHtml("beforeEnd", "<dt id=\"" + shortcutItem.get("id") + "-shortcut\">" +
                "<a href=\"#\">" +
    ...
    this.openGameModule__ = function (gameId){
//        var win = MainOS.desktop.getWindow(gameId + "-win");
        var module = ModuleLoader.getModule(gameId).instance;
//        if (!win) {
//            if (module) {
//                module.createWindow();
//                win = MainOS.desktop.getWindow(gameId + "-win");
//                module.addDefaultToolBar();
//            }
//        }

        var game = ModuleLoader.getModule(gameId).instance;
        var actuator = new Ext.Actuator(game);
        actuator.init();
        actuator.createWindow();
    }
};
