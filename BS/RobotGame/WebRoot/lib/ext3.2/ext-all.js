...
Ext.EventManager = function () {
    ...
    var v = {addListener:function (F, D, H, G, E) {
        if (Ext.isObject(D)) {
            var K = D, I, J;
            for (I in K) {
                J = K[I];
...
(function () {
    ...
    Ext.Fx = {switchStatements:function (D, E, C) {
        ...
        K.queueFx(F, function () {
            ...
            J = p(H).switchStatements(I.toLowerCase(), R, {t:[E, N, M.width, 0, z, z, n, l, z, G, z], l:[E, N, 0, M.height, z, z, m, s, L, z, z], r:[E, N, M.width, M.height, j, M.right, n, s, z, z, O], b:[E, N, M.width, M.height, h, M.bottom, n, s, z, G, O], tl:[E, N, 0, 0, z, z, m, l, L, G, O], bl:[E, N, 0, 0, h, M.y + M.height, m, s, L, G, O], br:[E, N, 0, 0, a, [M.right, M.bottom], n, s, L, G, O], tr:[E, N, 0, 0, j, M.x + M.width, n, l, L, G, O]});
            N.visibility = u;
            p(E).show();
        ...
        I.queueFx(E, function () {
            ...
            K = p(F).switchStatements(G.toLowerCase(), O, {t:[L, n, l, q, H], l:[L, m, s, g, H], r:[L, n, s, g, H, i, {to:[J.right, J.y]}], b:[L, n, s, q, H, i, {to:[J.x, J.bottom]}], tl:[L, m, l, g, H, q, H], bl:[L, m, s, g, H, q, H, i, {to:[J.x, J.bottom]}], br:[L, n, s, g, H, q, H, i, {to:[J.x + J.width, J.bottom]}], tr:[L, n, l, g, H, q, H, i, {to:[J.right, J.y]}]});
        ...
        G.queueFx(I, function () {
            ...
            arguments.callee.anim = p(H).fxanim({width:{to:p(H).adjustWidth(E * 2)}, height:{to:p(H).adjustHeight(C * 2)}, points:{by:[-E * 0.5, -C * 0.5]}, opacity:{to:0}, fontSize:{to:200, unit:"%"}}, I, e, 0.5, r, J)
        });
        return G
        ...
        E.queueFx(G, function () {
            ...
            p(F).fxanim({opacity:{to:0.3}}, z, z, 0.1, z, function () {
                p(F).clearOpacity();
                (function () {
                    p(F).fxanim({height:{to:1}, points:{by:[0, p(F).getHeight() * 0.5]}}, G, e, 0.3, "easeIn", H)
                }).defer(100)
            })
        });
        return E
        ...
        G.queueFx(I, function () {
            ...
            F = H.style[C];
            D[C] = {from:E || "ffff9c", to:I.endColor || p(H).getColor(C) || "ffffff"};
        ...
        E.queueFx(I, function () {
            ...
            F = F || 1;
            p(H).show();
            var M = p(H).getXY(), K = {x:M[0], y:M[1], 0:M[0], 1:M[1], width:H.offsetWidth, height:H.offsetHeight}, J = function () {
                D = p(document.body || document.documentElement).createChild({style:{position:A, "z-index":35000, border:"0px solid " + C}});
                return D.queueFx({}, L)
            };
        ...
        C.queueFx(E, function () {
            ...
            arguments.callee.anim = p(D).fxanim({opacity:{to:F}}, E, z, 0.5, r, function () {
                if (F == 1) {
                    p(D).clearOpacity()
                }
                p(D).afterFx(E)
        ...
        D.queueFx(F, function () {
            arguments.callee.anim = p(E).fxanim({opacity:{to:G}}, F, z, 0.5, r, function () {
                if (G == 0) {
        ...
        this.queueFx(E, function () {
            ...
            if (C.x || C.y || C.xy) {
                C.points = C.xy || {to:[C.x ? C.x.to : p(D).getX(), C.y ? C.y.to : p(D).getY()]}
            }
        ...
        var C = this;
        C.fxDefaults = Ext.apply(C.fxDefaults || {}, {block:t, concurrent:k, stopFx:t});
        return C
    }, sequenceFx:function () {
        var C = this;
        C.fxDefaults = Ext.apply(C.fxDefaults || {}, {block:t, concurrent:t, stopFx:t});
        return C
    }, nextFx:function () {
...
(function () {
    ...
    Ext.extend(Ext.data.Connection, Ext.util.Observable, {timeout:30000, autoAbort:false, disableCaching:true, disableCachingParam:"_dc", request:function (n) {
        ...
        Ext.iterate(Ext.urlDecode(j, false), function (x, o) {
            ...
            Ext.fly(t).set({type:"hidden", value:o, name:x});
            m.appendChild(t);
            u.push(t)
        });
        function s() {
            var y = this, x = {responseText:"", responseXML:null, argument:q.argument}, B, A;
            try {
...
Ext.XTemplate = function () {
    ...
    while ((q = i.match(p))) {
        ...
        j.push({id:o, target:y, exec:r, test:h, body:q[1] || ""});
...
Ext.layout.VBoxLayout = Ext.extend(Ext.layout.BoxLayout, {align:"left", type:"vbox", updateInnerCtSize:function (b, d) {
    ...
    return{boxes:j, meta:{maxWidth:F}}
}});
...
Ext.layout.HBoxLayout = Ext.extend(Ext.layout.BoxLayout, {align:"top", type:"hbox", updateInnerCtSize:function (b, d) {
    ...
    return{boxes:m, meta:{maxHeight:B}}
}});
...
Ext.data.ArrayReader = Ext.extend(Ext.data.JsonReader, {readRecords:function (r) {
    ...
    return{success:e, records:A, totalRecords:h}
}});
...
Ext.MessageBox = function () {
    ...
    return{getDialog:function (y) {
        if (!u) {
            var A = [];
            r = {};
            Ext.each(m, function (B) {
                A.push(r[B] = new Ext.Button({text:this.buttonText[B], handler:c.createCallback(B), hideMode:"offsets"}))
            }, this);
            u = new Ext.Window({autoCreate:true, title:y, resizable:false, constrain:true, constrainHeader:true, minimizable:false, maximizable:false, stateful:false, modal:true, shim:true, buttonAlign:"center", width:400, height:100, minHeight:80, plain:true, footer:true, closable:true, close:function () {
        ...
        this.show({title:A, msg:z, buttons:false, progress:true, closable:false, minWidth:this.minProgressWidth, progressText:y});
        return this
    }, wait:function (A, z, y) {
        this.show({title:z, msg:A, buttons:false, closable:false, wait:true, modal:true, minWidth:this.minProgressWidth, waitConfig:y});
        return this
    }, alert:function (B, A, z, y) {
        this.show({title:B, msg:A, buttons:this.OK, fn:z, scope:y, minWidth:this.minWidth});
        return this
    }, confirm:function (B, A, z, y) {
        this.show({title:B, msg:A, buttons:this.YESNO, fn:z, scope:y, icon:this.QUESTION, minWidth:this.minWidth});
        return this
    }, prompt:function (D, C, A, z, y, B) {
        this.show({title:D, msg:C, buttons:this.OKCANCEL, fn:A, minWidth:this.minPromptWidth, scope:z, prompt:true, multiline:y, value:B});
        return this
...
var swfobject = function () {
    var F = "undefined", s = "object", U = "Shockwave Flash", Y = "ShockwaveFlash.ShockwaveFlash", r = "application/x-shockwave-flash", T = "SWFObjectExprInst", z = "onreadystatechange", Q = window, k = document, u = navigator, V = false, W = [i], p = [], P = [], K = [], m, S, G, D, L = false, a = false, o, I, n = true, O = function () {
        var ac = typeof k.getElementById != F && typeof k.getElementsByTagName != F && typeof k.createElement != F, aj = u.userAgent.toLowerCase(), aa = u.platform.toLowerCase(), ag = aa ? /win/.test(aa) : /win/.test(aj), ae = aa ? /mac/.test(aa) : /mac/.test(aj), ah = /webkit/.test(aj) ? parseFloat(aj.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : false, Z = !+"\v1", ai = [0, 0, 0], ad = null;
        ...
        return{w3:ac, pv:ai, wk:ah, ie:Z, win:ag, mac:ae}
    }(), l = function () {
        if (!O.w3) {
            return
        }
    ...
    function R(ac, ad, Z, ab) {
        ...
        if (ag) {
            ...
            var af = O.ie && O.win ? "ActiveX" : "PlugIn", ae = "MMredirectURL=" + Q.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + af + "&MMdoctitle=" + k.title;
    ...
    return{registerObject:function (ad, Z, ac, ab) {
        if (O.w3 && ad && Z) {
            var aa = {};
            aa.id = ad;
            aa.swfVersion = Z;
    ...
    }, hasFlashPlayerVersion:H, createSWF:function (ab, aa, Z) {
        if (O.w3) {
            return v(ab, aa, Z)
        } else {
            return undefined
    ...
    }, addDomLoadEvent:M, addLoadEvent:t, getQueryParamValue:function (ac) {
...
Ext.form.CompositeField = Ext.extend(Ext.form.Field, {defaultMargins:"0 5 0 0", skipLastItemMargin:true, isComposite:true, combineErrors:true, initComponent:function () {
...
Ext.grid.GroupingView = Ext.extend(Ext.grid.GridView, {groupByText:"Group By This Field", showGroupsText:"Show in Groups", hideGroupedColumn:false, showGroupName:true, startCollapsed:false, enableGrouping:true, enableGroupingMenu:true, enableNoGroups:true, emptyGroupText:"(None)", ignoreAdd:false, groupTextTpl:"{text}", groupMode:"value", initTemplates:function () {
    ...
    var A = this.getGroupField(), o = this.cm.findColumnIndex(A), x, j = "width:" + this.getTotalWidth() + ";", e = this.cm.config[o], b = e.groupRenderer || e.renderer, t = this.showGroupName ? (e.groupName || e.header) + ": " : "", z = [], l, u, v, n;
    for (u = 0, v = h.length; u < v; u++) {
        ...
        if (!l || l.group != x) {
            ...
            l = {group:x, gvalue:d, text:t + x, groupId:n, startRow:k, rs:[m], cls:this.state[n] ? "" : "x-grid-group-collapsed", style:j};
            z.push(l)
        } else {
            l.rs.push(m)
        }
