...
var ACEEditor = function(config) {
    ACEEditor.superclass.constructor.call(this, config);
}
 Ext.extend(ACEEditor,Ext.util.Observable, {
    path: '',
    sourceCode: '',
    autofocus: true,
    fontSize: '12px',
    ...
    constructor: function(owner, config)
    {
        ...
        ACEEditor.superclass.constructor.call(this,arguments);
        //me.callParent();
    },
